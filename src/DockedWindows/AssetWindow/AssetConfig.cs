...
namespace MapStudio.UI
{
    public class AssetConfig
    {
        ...
        {
            string path = Path.Combine(Environment.GetEnvironmentVariable("ConfigDir")!,"AssetConfig.json");
            if (!File.Exists(path))
        ...
        public void Save()
        {
            ...
            File.WriteAllText(Path.Combine(Environment.GetEnvironmentVariable("ConfigDir")!,"AssetConfig.json"), json);
        }
